...
<div class="py-3 background">
    <div class="container">
        <div class="d-flex">
            <a href="{{ route('admin.categories.index') }}" class="decoration_none"><h3 class="m_r text-capitalize">categories </h3></a><h3>. update</h3>
        </div>
    </div>
</div>
            ...
            <div class="row box_shadow p-3">
                ...
                <div class="col-6 my-2">
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control" name="title" id="title" placeholder="title" value="{{$category->title}}">
                    </div>
